package se.chau.microservices.authorization.service;
...
import se.chau.microservices.authorization.jwt.Jwk;
...
public class Oauth2AuthorizationServerConfig {
    ...
    private SecurityFilterChain processAuth2(HttpSecurity http) {
        try {
